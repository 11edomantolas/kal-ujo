                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('username', $user['username']); ?>" name="username"
                                id="username" type="text" class="form-control" autocomplete="off"
                ...
                <!-- <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_perusahaan', $user['nama_perusahaan']); ?>" name="nama_perusahaan" id="nama_perusahaan" type="text" class="form-control" autocomplete="off" placeholder="Nama Perusahaan Anda...">
                        </div>
                        <?= form_error('nama_perusahaan', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div> -->
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama">Nama Pengguna</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                            ...
                            <input value="<?= set_value('nama', $user['nama']); ?>" name="nama" id="nama" type="text"
                                class="form-control" autocomplete="off" placeholder="Nama Anda...">
                        </div>
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('email', $user['email']); ?>" name="email" id="email"
                                type="text" autocomplete="off" class="form-control" placeholder="Email...">
                        </div>
                ...
                <!-- <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('alamat', $user['alamat']); ?>" name="alamat" id="alamat"
                                autocomplete="off" type="text" class="form-control" placeholder="Alamat...">
                        </div>
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_telp', $user['no_telp']); ?>" name="no_telp" id="no_telp"
                                type="text" class="form-control" autocomplete="off" placeholder="Nomor Telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_wa', $user['no_wa']); ?>" name="no_wa" id="no_wa"
                                type="text" class="form-control" autocomplete="off" placeholder="Nomor Whatsapp PIC...">
                        </div>
