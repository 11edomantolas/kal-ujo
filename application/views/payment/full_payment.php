...
<div class="card shadow-lg border-0 mb-4 rounded-4 overflow-hidden">
    ...
    <div class="card-body bg-light">
        ...
        <table class="table table-hover align-middle text-dark w-100 table-fixed" id="uangJalanTable">
            <thead class="table-primary text-center text-nowrap">
                <tr>
                    ...
                    <th class="text-center col-id">No Surat Jalan</th>
                    ...
                    <th class="text-center col-ton">Tonase</th>
                    <th class="text-center col-action">Aksi</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($full as $d): ?>
                    <tr class="data-row">
                        ...
                        <td><?= $d['destination']; ?></td>
                        <td>
                            <?= rtrim(rtrim(number_format((float) $d['tonase'], 2, '.', ''), '0'), '.') ?>
                        </td>
                        <td class="text-center">
                            <button class="btn btn-info btn-sm" data-bs-toggle="modal"
                                data-bs-target="#detailModal_<?= $d['id']; ?>">
        ...
        <!-- FORM -->
        <form id="ProcessForm" action="<?= base_url('payment/process_full'); ?>" method="POST" target="downloadFrame">
...
<!-- ================= MODAL (DI LUAR TABLE) ================= -->
<?php foreach ($full as $d): ?>
    <div class="modal fade" id="detailModal_<?= $d['id']; ?>" tabindex="-1">
                ...
                <div class="modal-body bg-light">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            ?>
                            <p>
                                <strong>Biaya Additional (Rp):</strong>Rp.
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#uangJalanTable').DataTable({
            ...
            responsive: false,
            language: {
                emptyTable: "Belum ada data yang perlu dilunasi"
            },
            dom: 't',
            pageLength: 10,
            order: []
        ...
        $.fn.dataTable.ext.search.push(function (settings, data) {
            ...
            const rowNounit = data[4].toLowerCase();
