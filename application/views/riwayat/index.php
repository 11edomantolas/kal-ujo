    ...
    <div class="card-header text-white py-3" style="background: linear-gradient(90deg, #0056b3, #007bff);">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <h4 class="m-0 fw-bold">
                <i class="fas fa-money-check-alt me-2"></i> History Transaksi Berhasil
            </h4>
        </div>
    </div>
                        ...
                        foreach ($paid as $data): ?>
                            <tr>
                                ...
                                <td class="text-center fw-bold text-dark">
                                    <?= !empty(trim($data['no_surat_jalan'] ?? '')) ? $data['no_surat_jalan'] : '&mdash;' ?>
                                </td>
                                <td class="text-center"><?= number_format($data['tonase'], 2); ?></td>
